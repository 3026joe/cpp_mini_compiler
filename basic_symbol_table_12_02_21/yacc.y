...
GLOBAL
	...
	;
FUNC_DECLR
	: TYPE T_ID T_OPENPARENTHESIS LISTVAR T_CLOSEPARENTHESIS FUNC_DECLR2
	;
FUNC_DECLR2
    ...
    ;
MAIN
	: TYPE T_MAIN T_OPENPARENTHESIS MAIN2 T_CLOSEPARENTHESIS T_OPENCURLYBRACES STMT T_CLOSECURLYBRACES
	;
MAIN2
	: LISTVAR 
	| EMPTY
	;
STMT
	: DECLR ';' STMT {printf("stmt -> declr ; stmt \n");}
	| ASSGN ';' STMT
	| WHILE
	| SWITCH
	| T_COUT COUT ';' STMT
...
CIN
	...
	;
DECLR
	: TYPE LISTVAR {printf("declr -> listvar;\n");}
	;
TYPE
	: T_VOID
	| T_INT
	...
	;
LISTVAR
	: VAR LISTVAR2 {printf("listvar -> var\n");}
	;
LISTVAR2
    : ',' VAR LISTVAR2
    | EMPTY
...
VAR
	: T_ID
	| ASSGN {printf("var -> assign\n");}
	;
ASSGN
	: T_ID T_ASSIGNMENT EXPR {printf("assgn -> expr\n");}
	;
EXPR
	: T EXPR1 {printf("expr -> t\n");}
	;
EXPR1
	: REL_OP T EXPR1
	| EMPTY
